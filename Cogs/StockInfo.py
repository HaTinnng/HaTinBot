...
STOCK_INFO = {
    ...
    "멸망병원": "뭐든지 치료하는 멸망병원입니다!"
            "뭐든지 하락하는 현재 주식장을 치료하기 위해 등장했습니다! 과연 멸망병원은 살아남을 수 있을까요?",

    "르끌경호": "의뢰한 사람을 안전하게 지키는 르끌경호입니다!"
            "이 경호회사를 본 사람들은 여기를 털꺼라고 생각을 못하게 한다고 다들 말하네요! 얼마나 대단한 경호일까요?"
