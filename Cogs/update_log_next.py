...
NEXT_UPDATE_LOGS = [
    {
        ...
        "details": [
            ...
            "🔹 종목소개 수정(삭제되는 멸망병원, 르끌경호에 대한 내용 삭제)",
            "🔹 주식쿠폰 수정(기존의 쿠폰은 삭제, 새로운 쿠폰이 새롭게 추가)",
            "🔹 시즌결과 추가(유저데이터가 지우기 쉬워 칭호가 유지되기 어려워 TOP3의 결과를 데이터에 저장)",
            "🔹 예금/출금 추가(예금시 하루에 1번 예금금에서 0.5% 이자가 지급됩니다, 주식구매나 룰렛, 복권시 예금금은 미포함됩니다.)",
            "🔹 대출/대출상환 추가(최대 500,000원까지 대출이 되며 대출후 24시간이 지날때마다 복리로 3%이자가 계산이 됩니다.)",
            "🔹 주식도움말 변경 및 내용 추가",
            "\u200b",
            "**예정 업데이트**",
            "⛏️ **광산 시스템 도입**: 방치형 게임을 도입.(주식과 별개로 운영)",
            "⚾ **야구게임 추가**: 컴퓨터가 생각하는 숫자를 맞춰보세요!(돈을 이용하지 않음)",
            "폭탄 게임 결과에 폭탄이 어디였는지 출력",
